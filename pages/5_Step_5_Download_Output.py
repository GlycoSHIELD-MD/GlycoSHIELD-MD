...
st.markdown("""
You can download the multimodel file with selected number of glycan conformers or the zipped folder 
containing a full GlycoSHIELD run output. 
...
There, in the "Draw Multiple Frames" field put ```1:1:X``` where X is the total 
number of conformers you would like to see.
